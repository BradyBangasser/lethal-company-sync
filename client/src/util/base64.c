 ...
 */
unsigned char *base64Encode(const unsigned char *src, size_t len, size_t *out_len) {
 ...
 */
unsigned char *base64Decode(const unsigned char *src, size_t len, size_t *out_len) {
